...
const PRESETS = [
  ...
  },
  {
    ...
    get: () => {
      const t = todayStr(); const mon = startOfWeek(t);
  ...
  },
  {
    ...
    get: () => {
      const t = todayStr(); const mon = startOfWeek(t); const lastMon = addDays(mon, -7);
...
const DateWiseFilters = ({ onFetch, loading }) => {
                ...
                return (
                  <button
                    ...
                    className={`w-full flex items-center gap-2.5 px-4 py-2.5 text-sm transition-colors ${
                      sel ? 'bg-blue-600 text-white' : 'text-slate-700 hover:bg-slate-50'
                    }`}
                  >
...
export default DateWiseFilters;
