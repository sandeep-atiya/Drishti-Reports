...
const COLS = [
  ...
  { key: 'Transfer To Sales',    label: 'Transfer To Sales',  align: 'right',  minW: 145, type: 'number' },
  ...
  { key: 'Calls Order Con',      label: 'Calls Order Con',    align: 'center', minW: 128, type: 'pct' },
];
