...
import { formatNumber, formatCurrency, computeDateWiseCampaignTotals } from '../utils/dateWiseCampaignHelpers';

const COLS = [
  { key: 'Date',                 label: 'Date',                align: 'left',   minW: 110, type: 'date'     },
  { key: 'Campaign',             label: 'Campaign',            align: 'left',   minW: 200, type: 'name'     },
...
/* ── Main Table ─────────────────────────────────────────────────────────────── */
const DateWiseCampaignTable = ({ rows = [] }) => {
  ...
  const totals   = useMemo(() => computeDateWiseCampaignTotals(filtered), [filtered]);
    ...
    <div>
      ...
      <div className="px-4 py-3 border-b border-slate-100 bg-slate-50/60 flex items-center gap-2">
        ...
        <input
          ...
          placeholder="Search campaign name or date…"
...
export default DateWiseCampaignTable;
